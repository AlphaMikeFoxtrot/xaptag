                ...
                <TouchableOpacity onPress={() => {
                    ...
                    <Card style={styles.container_card}>
                        <CardItem style={styles.container_card_item}>
                            <Image source={require('../../assets/images/bottomNavStock/perscription.png')} style={styles.card_item_image} />
                            <Text style={styles.card_item_text}>Upload Prescription</Text>
                        </CardItem>
                    </Card>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => { this.props.navigation.navigate('MyReports', {
                    ...
                    <Card style={styles.container_card}>
                        <CardItem style={styles.container_card_item}>
                            ...
                            <Text style={styles.card_item_text}>View Uploaded Prescriptions</Text>
                        </CardItem>
                    </Card>
                </TouchableOpacity>
            </View>
